...
GRANT INSERT, SELECT ON public.eval_log TO app_chat_writer;
GRANT USAGE, SELECT ON SEQUENCE public.eval_log_id_seq TO app_chat_writer;

ALTER TABLE public.eval_log
